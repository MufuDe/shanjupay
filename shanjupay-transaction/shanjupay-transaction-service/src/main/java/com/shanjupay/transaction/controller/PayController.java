...
public class PayController{
    ...
    public String wxOAuth2CodeReturn(@RequestParam String code,@RequestParam("state") String state) throws Exception {
    ...
    public void createAlipayOrderForStore(OrderConfirmVO orderConfirmVO, HttpServletRequest request,
        ...
        //保存订单，调用第三方支付渠道代理服务，实现第三方支付宝的下单
